...
<table width='685' cellspacing='0' cellpadding='5' border='1'>
  ...
  <tr>
    <th width='182' align='left' bgcolor='#ddd'>Email ID</th><th width='477' align='left'><label for='cardtype'>
      <input name='emailid' type='text' id='emailid' onkeydown='return isNumeric(event.keyCode);' readonly width='260' value="<?php echo $rscustomer['email']; ?>" required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}"/>
    </label></th></tr><tr>
