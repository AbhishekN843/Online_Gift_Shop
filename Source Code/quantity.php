...
if(isset($_POST['submit']))
{
	...
	{
		mysqli_query($con,"INSERT INTO quantity(prod_id,size_id, qty) VALUES('$_POST[productname]','$_POST[size]','$_POST[quantity]')");
        	...
        	<h2> Quantity          </h2>
			 ...
			 <form method="post" action="" name="subcategory" onsubmit="return validatesubcategory()">
			    ...
			    <table width="531" height="176" border="1">
			      <tr>
			        <th height="26" scope="row">Product Name</th>
			        <td><label for="productname"></label>
					  ...
					  while($rspro = mysqli_fetch_array($resultpro))
					  {
						  ...
						  {
						  echo "<option value='$rspro[product_id]' selected>$rspro[prodname]</option>";
						  }
						  else
						  {
							   echo "<option value='$rspro[product_id]'>$rspro[prodname]</option>";
						  }
